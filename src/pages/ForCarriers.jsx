      ...
      <section className={styles.section}>
        ...
        <ol className={styles.carriers__steps}>
          <li className={styles.carriers__stepsItem}>
            <span className={styles.carriers__stepsItemTitle}>Реєстрація профілю</span> — додайте інформацію про флот та контакти.
          </li>
          <li className={styles.carriers__stepsItem}>
            <span className={styles.carriers__stepsItemTitle}>Публікація рейсів</span> — створюйте маршрути та розклад.
          </li>
          <li className={styles.carriers__stepsItem}>
            <span className={styles.carriers__stepsItemTitle}>Прийом бронювань</span> — керуйте місцями та оплатами в панелі.
          </li>
        </ol>
      </section>
      ...
      <section className={styles.section}>
        ...
        <div className={styles.carriers__advantages}>
          <article className={styles.carriers__card}>
            ...
            <p className={styles.carriers__cardText}>Звіти по рейсам і доходам.</p>
          </article>

          <article className={styles.carriers__card}>
            <h3 className={styles.carriers__cardTitle}>Масштабування</h3>
            <p className={styles.carriers__cardText}>Додавайте сотні рейсів швидко.</p>
          </article>
